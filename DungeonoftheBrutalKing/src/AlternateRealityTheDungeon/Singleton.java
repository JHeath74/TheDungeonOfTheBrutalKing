...
import Weapons.ARTDBattleAxe;
import Weapons.ARTDBattleHammer;
import Weapons.ARTDCrossbow;
import Weapons.ARTDDaggger;
import Weapons.ARTDDart;
import Weapons.ARTDFlail;
import Weapons.ARTDHand;
import Weapons.ARTDJavelin;
import Weapons.ARTDLongSword;
import Weapons.ARTDLongbow;
import Weapons.ARTDShortSword;
import Weapons.ARTDShortbow;
import Weapons.ARTDSling;
import Weapons.ARTDStilleto;
import Weapons.ARTDSword;
import Weapons.ARTDWarNet;
import Weapons.ARTDWhip;
...
public class Singleton 
{
	...
	private static List<Shields> addShields() {
		...
		shieldList = new ArrayList<Shields>();
	...
	{
		monsterList = new ArrayList<Enemies>();
